...
Establish a connection to DB2 Warehouse. You'll need to fill in details of your dashDB instance in the connection.R file (if you haven't done so already) the DB2 Warehouse instance's hostname, user ID (uid) and password (pwd) as well as the name of the vetting table.
